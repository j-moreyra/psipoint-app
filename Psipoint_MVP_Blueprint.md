# Psipoint MVP — Project Blueprint (v4)
...
### Known Syncta weaknesses (Psipoint's wedge)
...
### Table: `companies` (the tester's business — the Psipoint tenant)
...
├────────────────────────────────────────────┤
│  Generated by Psipoint · psipoint.app         │
└────────────────────────────────────────────┘
```
...
| Domain / trademark on "Psipoint" | Verify before Phase 1 |
...
- 1+ tester says "I left Syncta for Psipoint"
